...
Letters.prototype = {
    init: function(options){
        this.size = options && options.hasOwnProperty('size') ? options.size : 90;
    ...
    initAlphabet: function(weight, rounded){
        ...
        this.alphabet = {
            'a': {
                ...
                initial: [{begin: '5%', end: '5%'}, {begin: '100%', end: '100%'}],
                final: [{begin: '40%', end: '125% + 1'}, {begin: '30%', end: p50plus23}]
            },
            'b': {
                svg: svgSmall,
                paths: [circleCenter, lineLeft],
                initial: [{begin: '-125%', end: '-125%'}, {begin: '5%', end: '5%'}],
                final: [{begin: '-125%', end: '-30%'}, {begin: p50minus35, end: p50plus23}]
            },
            'c': {
                svg: svgSmall,
                paths: [circleCenter],
                initial: [{begin: '105%', end: '105%'}],
                final: [{begin: '-60%', end: '15%'}]
            },
            'd': {
                svg: svgSmall,
                paths: [circleCenter, lineRight],
                initial: [{begin: '125%', end: '125%'}, {begin: '5%', end: '5%'}],
                final: [{begin: '40%', end: '125%'}, {begin: p50minus35, end: p50plus23}]
            },
            'e': {
                svg: svgSmall,
                paths: [circleCenter, lineE],
                initial: [{begin: '-105%', end: '-105%'}, {begin: '5%', end: '5%'}],
                final: [{begin: '40%', end: '125% + 1'}, {begin: '50%', end: p50plus23}]
            },
            'f': {
                svg: svgFJRT,
            ...
            'h': {
                ...
                final: [{begin: '-123%', end: '-75% + 1'}, {begin: p50minus35, end: '70%'}, {begin: '50%', end: p50plus23}]
            },
            'i': {
            ...
            'k': {
                ...
                final: [{begin: '45%', end: '105%'}, {begin: p50minus35, end: p50plus23}]
            },
            'l': {
                svg: {width: (width - (2 * radius)), height: height},
                paths: [lineCenter],
            ...
            'y': {
                svg: svgSmall,
                paths: [circleCenter, circleGY, lineRight],
                initial: [{begin: '1', end: '-25%'}, {begin: '1', end: '1'}, {begin: p50minus23, end: p50minus23}],
                final: [{begin: '-75%', end: '-10%'}, {begin: '25% - 1', end: '50%'}, {begin: p50minus23, end: p50plus23}]
            },
            'z': {
                svg: svgSXZ,
                paths: [circleSXZ, circleSXZ2],
